        ...
        <div class="col-lg-12 col-xl-6">
            <form action=""method="post"enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text"id="user_acontact"class="form-control" placeholder="Enter your Contact Number"autocomplete="off"required="required"name="user_contact">
                </div>
                <div class="mt-4 pt-2">
...
if($row_count>0){
    ...
    echo "<script>widnow.open('checkout.php','_self')</script>";
}
else{
