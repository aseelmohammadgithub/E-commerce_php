...
function get_unique_categories()
{
    ...
    // condition for categories displaying separately
    if (isset($_GET['category'])) {
        ...
        if ($num_of_rows == 0) {
            echo "<h2 class='text-center text-danger'>Stock unavailable</h2>";
        }
        while ($row = mysqli_fetch_assoc($result_query)) {
            $product_id = $row['product_id'];
            $product_title = $row['product_title'];
            ...
            <div class="col">
              <div class="card">
                <img class="card-img-top" src="./admin_area/product_images/<?php echo $product_image1; ?>" alt="Card image cap">
                <div class="card-body">
...
// condition for brands displaying separately
